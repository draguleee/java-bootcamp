...
public class Main {
    ...
    // Create the Scanner at the class level
    static Scanner scan = new Scanner(System.in);

    public static void main(String[] args) {

        // Instantiate a ContactManager object with an initial array of Contact objects
        ContactManager contactManager = new ContactManager(contactData());

        // Display the contacts
        displayContacts(contactManager);

        // Print the number of contacts and ask the user to edit them
    ...
    /**
     * contactData() - returns an array of Contact objects with initial data
     * @return
     */
    ...
    /**
     * displayContacts() - displays the contacts
    ...
    /**
     * editedContact() - prompts the user for the Contact object info then returns a new Contact object with the provided info
     * @return
     */
