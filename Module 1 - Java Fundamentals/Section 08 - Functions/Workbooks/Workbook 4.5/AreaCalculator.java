...
public class AreaCalculator {
    public static void main(String[] args) {
        ...
        // Call printAreas function
        printAreas(square, rectangle, triangle, circle);

    } 

    /**
     * areaSquare - returns the area of a square.
     * @param side (double)
     * @return area (double)
     * 
     * Inside the function: 
    ...
    /**
     * areaRectangle – returns the area of a rectangle.
     * @param length (double).
     * @param width  (double).
     * @return area (double)
     * 
    ...
    /**
     * areaTriangle – it returns the area of a triangle.
     * @param base: (double).
     * @param height: (double).
     * @return area (double)
     * 
    ...
    /**
     * areaCircle – it returns the area of a circle.
     * @param radius (double).
     * @return area (double)
     * 
     * Inside the function: 
    ...
    /**
     * printAreas – it prints four areas
