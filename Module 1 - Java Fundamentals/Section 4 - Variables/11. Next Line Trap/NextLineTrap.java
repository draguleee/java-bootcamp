 ...
 *   * nextLong(): skips the white space and picks up the next Long;
 *   * next(): skips the white spac and picks up the next String;
 *   * nextLine(): picks up a line of data
 */
...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        // nextLine() trap
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine();     // throwaway nextLine() to be wated on empty space
