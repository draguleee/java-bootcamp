 ...
 * - nextInt(): skips the white space and picks up the next Integer
 * - nextDouble(): skips the white space and picks up the next Double
 * - nextLong(): skips the whie space and picks up the next Long
 * - next(): skip the white space and picks up the next String
 * - next:ine() picks up a line of data
 * 
 */
...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        // next() example (or use nextLine() with a throwaway nextLine() which will get skipped)
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine();
